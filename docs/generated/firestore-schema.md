...
Source of truth: `COLLECTION_SCHEMAS` in `@ttt-productions/ttt-core/doc-schemas`. 169 collections bound. Regenerated by `scripts/generate-schema-docs.mjs`.
...
| `announcementMessage` | `string` | yes |
| `rateLimitMultiplier` | `number` | yes |
| `publicDocumentVersions` | `{ documents, requiredAcceptanceLevel }` | yes |

## `_appConfig/dmcaPolicy`
...
| `lastUpdated` | `number` |  |
| `intro` | `string` |  |
| `contactBlocks` | `{ id, heading, order, rows }[]` |  |
| `sections` | `{ id, heading, level, body, order }[]` |  |

## `_appConfig/futurePlans`
...
| `version` | `number` | yes |
| `lastUpdated` | `number` | yes |

## `_appConfig/takeItDownPageCopy`
...
## `_serverData/feedbackLists/feedbackAliases/{aliasId}`
...
| `schemaVersion` | `1` |  |
| `groupKey` | `string` |  |
| `itemType` | `'username' \| 'craft-skill' \| 'commission-listing' \| 'commission-proposal' \| 'square-streetz-post' \| 'profile-picture' \| 'guild-invite-message' \| 'guild-chat-message' \| 'conversation-file' \| 'hall-library-item' \| 'hall-library-sub-item' \| 'audition' \| 'audition-entry' \| 'work-project' \| 'work-asset' \| 'work-realm'` |  |
| `totalReports` | `number` |  |
...
| `reportedItemId` | `string` | yes |
| `parentItemId` | `string \| null` | yes |
| `reportedUserId` | `string` | yes |
| `moderationState` | `'admin_hidden' \| 'resolved_restored' \| 'resolved_removed'` | yes |
| `contentHidden` | `boolean` | yes |
| `moderatedAt` | `number` | yes |
| `edgeSyncState` | `'processing' \| 'failed' \| null` | yes |
| `edgeSyncProcessingAt` | `number` | yes |
| `edgeSyncOp` | `'block' \| 'blockClear'` | yes |
| `edgeSyncOwnerType` | `'userProfile' \| 'craftSkill' \| 'squareStreetzPost' \| 'workProject' \| 'workContent' \| 'hallItem' \| 'commissionListing' \| 'commissionProposal' \| 'audition' \| 'auditionEntry' \| 'conversationFile' \| 'realmFile' \| 'safetyEvidence'` | yes |
| `edgeSyncOwnerId` | `string` | yes |
| `edgeSyncAssetIds` | `string[]` | yes |
| `edgeSyncError` | `string` | yes |
| `edgeSyncFailedAt` | `number` | yes |
| `resolutionOutcome` | `'founded' \| 'unfounded'` | yes |
| `resolvedBy` | `string` | yes |
| `resolvedAt` | `number` | yes |
| `resolutionUserFacingReasonCode` | `string` | yes |
| `resolutionUserFacingReasonDetail` | `string` | yes |
| `resolutionAdminNote` | `string` | yes |
| `tombstoneAppliedAt` | `number` | yes |
| `lastError` | `string \| null` | yes |
| `failedAt` | `number \| null` | yes |
| `failedCommandDocId` | `string` | yes |
| `supersededByCaseId` | `string` | yes |
| `supersededAt` | `number` | yes |
| `supersededPartialAt` | `number` | yes |
| `pendingHoldRelease` | `boolean` | yes |

## `activeReportGroups/{groupKey}/reportGroupCountedReports/{reportId}`
...
## `allWorkProjects/{workProjectId}/hallSubmissionReservation/reservation`
...
| `chatMessageLocator` | `{ kind, mediaAssetId } \| { kind, hallItemId, subItemId } \| { kind, postId } \| { kind, profileUid } \| { kind, profileUid } \| { kind, profileUid, craftSkillId } \| { kind, commissionListingId } \| { kind, commissionListingId, commissionProposalId } \| { kind, workProjectId } \| { kind, workProjectId, workAssetId } \| { kind, workRealmId } \| { kind, auditionId } \| { kind, auditionId, auditionEntryId } \| { kind, channelId, messageId } \| { kind, conversation, conversationFileId, mediaAssetId } \| { kind, channelId, messageId } \| { kind, url } \| { kind, textRef }` | yes |
| `contextResolutionPending` | `boolean` | yes |
| `crossoverLegs` | `{ servingDeny, servingDeniedAt, servingDenyFailedAt, servingDenyLastError, photoDna, photoDnaScannedAt, photoDnaFailedAt, photoDnaLastError }` | yes |

## `childSafetyCases/{caseId}/childSafetyCaseAccounts/{uid}`
...
## `childSafetyCases/{caseId}/childSafetyCaseAccounts/{uid}/childSafetyCaseAccountHistory/{historyId}`
...
## `childSafetyCases/{caseId}/childSafetyDecisions/{decisionId}`
...
## `childSafetyCases/{caseId}/childSafetyDecisions/{decisionId}/childSafetyDecisionViews/{viewId}`
...
## `childSafetyCases/{caseId}/ncmecPortalCorrections/{correctionId}`
...
| `portalReceiptArtifactId` | `string` |  |
| `proofText` | `string` | yes |
| `ncmecReportId` | `string` |  |
| `recordedByUid` | `string` |  |
| `recordedAt` | `number` |  |

## `childSafetyCases/{caseId}/ncmecSubmissions/{submissionId}/ncmecSubmissionFiles/{fileId}`
...
## `childSafetyCases/{caseId}/portalReceiptArtifacts/{artifactId}`
...
| `resolvedTarget` | `{ schemaVersion, itemType, canonicalParentPath, canonicalItemId, revision, ownerUid, ownerBlockKey, mediaAssetId, channelId, messageId, locator, resolvedAt }` |  |
| `snapshotRef` | `string` |  |
| `canonicalTargetKey` | `string` |  |
| `narrativeRef` | `string` | yes |
| `protectedFork` | `'childSafetyCase' \| 'nciiCase'` | yes |
| `escalatedToCase` | `string` | yes |
| `status` | `'pending_review' \| 'grouped' \| 'actioned' \| 'dismissed'` |  |
| `createdAt` | `number` |  |
| `updatedAt` | `number` |  |

## `contentReports/{reportId}/privateDetails/narrative`
...
## `contentReports/{reportId}/privateDetails/narrativeEscalation`
...
| `rejectedFilePath` | `string` | yes |
| `pendingFile` | `{ id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status }` | yes |
| `appealMessage` | `string` | yes |
...
| `conversationFileUploadCount` | `number` | yes |
| `conversationFileBytesReserved` | `number` | yes |
...
## `hallItems/{hallItemId}/hallItemTales/{itemId}`
...
## `hallItems/{hallItemId}/hallItemTelevision/{itemId}`
...
## `hallItems/{hallItemId}/hallItemTunes/{itemId}`
...
| `publicationKind` | `'profilePicture' \| 'squarePostMedia' \| 'workAsset' \| 'hallCover' \| 'realmCover' \| 'workContentMedia' \| 'auditionMedia' \| 'commissionListingMedia' \| 'commissionProposalMedia' \| 'craftSkillMedia' \| 'conversationFile'` |  |
...
| `parentWaitStartedAt` | `number` | yes |
| `createdAt` | `number` |  |
| `authorityAppliedAt` | `number` | yes |
| `completedAt` | `number` | yes |
| `deadLetteredAt` | `number` | yes |
| `expireAt` | `custom` | yes |
...
| `mediaKind` | `'image' \| 'video' \| 'audio'` |  |
| `fileOrigin` | `'profile-picture' \| 'craft-skill-media' \| 'squareStreetz' \| 'commission-posting' \| 'commission-proposal' \| 'audition-prompt' \| 'audition-entry' \| 'admin-audition-prompt' \| 'hallLibrary-cover-square' \| 'hallLibrary-cover-poster' \| 'hallLibrary-cover-cinematic' \| 'realm-cover' \| 'chapter-photo' \| 'tune-track-photo' \| 'tune-track-audio' \| 'television-episode-photo' \| 'television-episode-video' \| 'conversation-file' \| 'work-asset' \| 'ncii-evidence'` |  |
| `ownerType` | `'userProfile' \| 'craftSkill' \| 'squareStreetzPost' \| 'workProject' \| 'workContent' \| 'hallItem' \| 'commissionListing' \| 'commissionProposal' \| 'audition' \| 'auditionEntry' \| 'conversationFile' \| 'realmFile' \| 'safetyEvidence'` |  |
| `ownerId` | `string` |  |
| `workProjectId` | `string` | yes |
| `realmId` | `string` | yes |
| `createdByUid` | `string` |  |
...
| `realmFileCanonStatus` | `'none' \| 'pendingApproval' \| 'nonCanon' \| 'canon'` |  |
| `realmFileFolderId` | `string` | yes |
| `realmFileShareRequestId` | `string` | yes |
| `realmFileShareRequestedByUid` | `string` | yes |
| `realmFileShareRequestedAt` | `number` | yes |
...
| `scope` | `{ kind, workProjectId } \| { kind, workProjectId, workFileFolderId } \| { kind, guildInviteId } \| { kind, adminDispatchId }` | yes |
| `authorityAppliedAt` | `number` | yes |
| `publishedAt` | `number` | yes |
...
| `ownerType` | `'userProfile' \| 'craftSkill' \| 'squareStreetzPost' \| 'workProject' \| 'workContent' \| 'hallItem' \| 'commissionListing' \| 'commissionProposal' \| 'audition' \| 'auditionEntry' \| 'conversationFile' \| 'realmFile' \| 'safetyEvidence'` |  |
| `ownerId` | `string` |  |
| `variantKeys` | `'full' \| 'medium' \| 'small' \| 'main'[]` |  |
...
| `restoreSkipped` | `"directHidden"` | yes |
...
## `nciiCases/{caseId}/closureEvents/{eventId}`

| Field | Type | Optional |
| --- | --- | --- |
| _(document)_ | `{ kind, revision, closure, at } \| { kind, revision, reasonInternal, actorId, at }` |  |
...
## `nciiRemovalJobs/{jobId}/nciiRemovalTargets/{targetKeyHash}`
...
| `surface` | `'original' \| 'hallCopy' \| 'profileMedia' \| 'conversationFile' \| 'variant' \| 'cacheServing' \| 'exactHashMatch'` |  |
...
## `notificationArchiveAllJobs/{jobId}`
...
| `userId` | `string` |  |
| `category` | `'user' \| 'admin'` |  |
| `actorSystemRole` | `'admin' \| 'jrAdmin' \| null` | yes |
...
| Field | Type | Optional |
| --- | --- | --- |
| _(document)_ | `{ id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status } \| { id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status } \| { id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status, completedAt, uploadTrayClearedAt, uploadTrayClearedBy, uploadTraySeenAt, uploadTraySeenBy, result } \| { id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status, failedAt, uploadTrayClearedAt, uploadTrayClearedBy, uploadTraySeenAt, uploadTraySeenBy, errorCategory, errorMessage } \| { id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status, rejectedAt, uploadTrayClearedAt, uploadTrayClearedBy, uploadTraySeenAt, uploadTraySeenBy, rejectionType, errorMessage, violationId, result }` |  |

## `pendingMediaArchive/{pendingMediaId}`

| Field | Type | Optional |
| --- | --- | --- |
| _(document)_ | `{ id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status, completedAt, uploadTrayClearedAt, uploadTrayClearedBy, uploadTraySeenAt, uploadTraySeenBy, result, archivedAt } \| { id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status, failedAt, uploadTrayClearedAt, uploadTrayClearedBy, uploadTraySeenAt, uploadTraySeenBy, errorCategory, errorMessage, archivedAt } \| { id, userId, fileOrigin, originalFileName, originalContentType, originalSize, pendingStoragePath, targetInfo, textContent, clientContext, clientMediaClaim, publicationState, moderationOverride, createdAt, updatedAt, processingStartedAt, processingAttemptCount, processingLeaseExpiresAt, terminalAt, status, rejectedAt, uploadTrayClearedAt, uploadTrayClearedBy, uploadTraySeenAt, uploadTraySeenBy, rejectionType, errorMessage, violationId, result, archivedAt } \| { parseFailed, archivedAt, raw }` |  |
...
| `legalReviewNotice` | `{ revision, acknowledgedAt }` | yes |
| `createdAt` | `number` |  |
| `updatedAt` | `number` |  |
...
## `publicDocumentDrafts/{documentId}`

| Field | Type | Optional |
| --- | --- | --- |
| _(document)_ | `{ documentId, content, baseVersion, savedBy, savedAt } \| { documentId, content, baseVersion, savedBy, savedAt } \| { documentId, content, baseVersion, savedBy, savedAt } \| { documentId, content, baseVersion, savedBy, savedAt } \| { documentId, content, baseVersion, savedBy, savedAt } \| { documentId, content, baseVersion, savedBy, savedAt }` |  |

## `publicDocumentReleases/{releaseId}`
...
| Field | Type | Optional |
| --- | --- | --- |
| _(document)_ | `{ documentId, content, version, releaseId, publishedBy, publishedAt } \| { documentId, content, version, releaseId, publishedBy, publishedAt } \| { documentId, content, version, releaseId, publishedBy, publishedAt } \| { documentId, content, version, releaseId, publishedBy, publishedAt } \| { documentId, content, version, releaseId, publishedBy, publishedAt } \| { documentId, content, version, releaseId, publishedBy, publishedAt }` |  |
...
## `safetyEvidenceJobs/{jobId}/safetyEvidenceJobDisposition/{locationId}`
...
## `safetyEvidenceJobs/{jobId}/safetyEvidenceJobItems/{itemId}`

| Field | Type | Optional |
| --- | --- | --- |
| _(document)_ | `{ role, bucket, key, generation, sizeBytes, sha256, md5, verifyResult } \| { role, sourceDiscriminator, request, provenanceRefs } \| { role, sourceDiscriminator, captureJobId, requestKind }` |  |
...
## `safetyReconcilerCursors/{cursorKey}`

| Field | Type | Optional |
| --- | --- | --- |
| `afterValue` | `number` | yes |
| `updatedAt` | `number` |  |
...
| `resourceType` | `'mediaAsset' \| 'hallItem' \| 'squarePost' \| 'profileImage' \| 'username' \| 'craftSkill' \| 'commissionListing' \| 'commissionProposal' \| 'workProject' \| 'workAsset' \| 'workRealm' \| 'audition' \| 'auditionEntry' \| 'guildInviteMessage' \| 'conversationFile' \| 'guildChatMessage' \| 'url' \| 'additionalText'` |  |
...
## `squareAnnouncementJobs/{jobId}`

| Field | Type | Optional |
| --- | --- | --- |
| `jobId` | `string` |  |
| `announcement` | `{ type, payload }` |  |
...
| Field | Type | Optional |
| --- | --- | --- |
| `reaperLastRunAt` | `number` | yes |
| `reaperCursorPath` | `string` | yes |
| `fullScanLastRunAt` | `number` | yes |
| `updatedAt` | `number` |  |
...
| `removalCompletionOutcome` | `'completed' \| 'completedWithApprovedException' \| 'unableToComplete' \| null` | yes |
| `retentionCompletedAt` | `number \| null` | yes |
| `createdAt` | `number` |  |
| `updatedAt` | `number` |  |

## `takeItDownRequests/{requestId}/privateDetails/requester`
...
## `takeItDownRequests/{requestId}/takeItDownActions/{actionId}`
...
## `takeItDownRequests/{requestId}/takeItDownEvidence/{evidenceId}`
...
## `takeItDownRequests/{requestId}/takeItDownEvidenceDisposition/{evidenceId}`
...
## `takeItDownRequests/{requestId}/takeItDownSubmissions/{submissionId}`
...
| `statusUpdatedAt` | `number` | yes |
| `statusUpdatedBy` | `string` | yes |
...
| `squareStreetzAgreementsVersion` | `number` | yes |
| `artisanCreatorAgreementsVersion` | `number` | yes |
| `hallDownloadAcknowledgedAt` | `number` | yes |
| `agreements` | `{ age, nudity, meet, cookies, terms, agreedOn, termsVersion, privacyVersion }` | yes |
| `publicDocumentAcceptance` | `{ documentVersions, acceptedLevel, legalReviewNoticeRevision, acceptedAt }` | yes |
