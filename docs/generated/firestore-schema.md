...
| --- | --- | --- |
| `id` | `string` | yes |
| `taskType` | `'adminDispatch' \| 'thresholdLibraryReview' \| 'userReport' \| 'content-appeal' \| 'stakeShareAnomaly' \| 'pledgeLedgerAnomaly' \| 'pledgePaymentRepairNeeded' \| 'pledgeDisputeOpened' \| 'pledgeRefundRequested'` |  |
| `taskId` | `string` |  |
| `originalPath` | `string` |  |
...
| `schemaVersion` | `1` |  |
| `inventoryId` | `string` |  |
| `reason` | `'orphan' \| 'fileTooLarge' \| 'imageTooLarge' \| 'archiveOrPolyglot' \| 'malformedPath' \| 'scanRejected'` |  |
| `bucket` | `string` |  |
| `key` | `string` |  |
| `generation` | `string` |  |
...
| `missingFieldCodes` | `'requesterName' \| 'contactEmail' \| 'contactPhone' \| 'requesterRole' \| 'electronicSignature' \| 'authorityBasis' \| 'authorityCertification' \| 'authorityEvidence' \| 'targetLocator' \| 'nonconsentStatement' \| 'supportingFacts' \| 'goodFaithCertification'[]` | yes |
| `nextAction` | `'none' \| 'submitSupplement' \| 'checkLater'` | yes |
| `removalDeadlineAt` | `number` | yes |
| `updatedAt` | `number` |  |
