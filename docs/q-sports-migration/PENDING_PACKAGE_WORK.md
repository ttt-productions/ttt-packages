...
- **Skipped in Q-Sports:** the waiver and hardware signature copy in `UPLOADS_AND_MEDIA.md`
  § Signatures (Units 5 and 12). They are built with the plain copy, and the race is closed when
  this lands.
