...
export const PROJECT_ACTIONS = {
  ...
  'project.shares.manage': {
    ...
    grantedTo: ['ProjectManager', 'ShareManager'],
  },
  ...
  'invite.send': {
    ...
    grantedTo: ['ProjectManager', 'InviteManager'],
  },
  'invite.list': {
    label: 'List invites',
  ...
  'file.view': {
    ...
    grantedTo: ['ProjectManager', 'FileViewer', 'FileManager'],
  },
  'file.upload': {
    label: 'Upload project files',
    description: 'Upload shared project files.',
    grantedTo: ['ProjectManager', 'FileManager'],
  },
  'file.delete': {
  ...
  'job.open': {
    ...
    grantedTo: ['ProjectManager', 'JobManager'],
  },
  'job.close': {
    label: 'Close jobs',
  ...
  'opportunity.open': {
    ...
    grantedTo: ['ProjectManager', 'OpportunityManager'],
  },
  'opportunity.edit': {
  ...
  'library.chapter.create': {
    ...
    grantedTo: ['ProjectManager', 'LibraryEditor'],
  },
  'library.song.create': {
  ...
  'library.review.submit': {
    ...
    grantedTo: ['ProjectManager', 'LibrarySubmitter'],
  },
  'chat.channel.create': {
    label: 'Create chat channels',
    description: 'Create project chat channels.',
    grantedTo: ['ProjectManager', 'ChatChannelManager'],
  },
  'chat.channel.update': {
