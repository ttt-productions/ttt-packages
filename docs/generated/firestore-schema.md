...
Source of truth: `COLLECTION_SCHEMAS` in `@ttt-productions/ttt-core/doc-schemas`. 66 collections bound. Regenerated by `scripts/generate-schema-docs.mjs`.
...
## `pledgePaymentsSummary/summary`

| Field | Type | Optional |
| --- | --- | --- |
| `totalPledgePayments` | `number` |  |
| `totalPledgePaymentsByType` | `{ card, paypal, crypto }` |  |
