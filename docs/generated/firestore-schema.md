...
Source of truth: `COLLECTION_SCHEMAS` in `@ttt-productions/ttt-core/doc-schemas`. 133 collections bound. Regenerated by `scripts/generate-schema-docs.mjs`.
...
| `state` | `'queued' \| 'awaitingManualFiling' \| 'completed' \| 'retracted'` |  |
